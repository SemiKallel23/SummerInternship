...
package local_project.helloworldjob_0_1;
...
/**
 * Job: HelloWorldJob Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class HelloWorldJob implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "HelloWorldJob";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				HelloWorldJob.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(HelloWorldJob.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
	...
	String titletMsgBox_1 = "Hello World";
 ...
 */
    ...
    public static void main(String[] args){
        final HelloWorldJob HelloWorldJobClass = new HelloWorldJob();

        int exitCode = HelloWorldJobClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = HelloWorldJob.class.getClassLoader().getResourceAsStream("local_project/helloworldjob_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = HelloWorldJob.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
try {
errorCode = null;tMsgBox_1Process(globalMap);
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : HelloWorldJob");
        }
...
/************************************************************************************************
 *     26643 characters generated by Talend Open Studio for Data Integration 
 *     on the June 28, 2024, 1:58:29 PM CET
 ************************************************************************************************/